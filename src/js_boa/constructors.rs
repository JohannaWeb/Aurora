...
pub(super) fn install_dom_constructors(context: &mut Context) {
    let constructors = r#"
        (function(global) {
            ...
            install("HTMLVideoElement", "HTMLElement");
            install("HTMLAudioElement", "HTMLElement");
            install("HTMLButtonElement", "HTMLElement");
            install("HTMLSpanElement", "HTMLElement");
            install("HTMLParagraphElement", "HTMLElement");
            install("HTMLHeadingElement", "HTMLElement");
            install("HTMLLIElement", "HTMLElement");
            install("HTMLUListElement", "HTMLElement");
            install("HTMLOListElement", "HTMLElement");
            install("HTMLTemplateElement", "HTMLElement");
            install("HTMLCanvasElement", "HTMLElement");
            install("HTMLIFrameElement", "HTMLElement");
            install("SVGElement", "Element");
            install("SVGSVGElement", "SVGElement");
        })(globalThis);
    "#;
